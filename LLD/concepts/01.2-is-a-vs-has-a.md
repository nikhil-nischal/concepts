...
## Overview
- Companion to [00a. What is LLD](00a-what-is-lld.md)'s conceptual definitions — this note
...
- Seen in [04. Decorator Design Pattern](04-decorator-design-pattern.md) (`ToppingDecorator extends
  Pizza` + holds a `Pizza` field) and [13. Proxy Design Pattern](13-proxy-design-pattern.md)
...
- Plain has-a: `Vehicle` holds a `DriveStrategy` field, injected via
  constructor, delegates `drive()` to it — see [02. Strategy Design Pattern](02-strategy-design-pattern.md)
...
- Both together: `ToppingDecorator implements Pizza` (is-a) while also
  ...
  [04. Decorator Design Pattern](04-decorator-design-pattern.md) and [13. Proxy Design Pattern](13-proxy-design-pattern.md)
...
## Related Topics
- [00a. What is LLD](00a-what-is-lld.md) — conceptual definitions of is-a, has-a,
  aggregation vs composition.
- [02. Strategy Design Pattern](02-strategy-design-pattern.md) — pure has-a example.
- [04. Decorator Design Pattern](04-decorator-design-pattern.md) — both is-a and has-a on one class.
- [13. Proxy Design Pattern](13-proxy-design-pattern.md) — both is-a and has-a on one class.
- [18. LLD of Chess Game (Mock Interview)](../examples/18-chess-game-lld.md) — a real interview correction: Piece's position
